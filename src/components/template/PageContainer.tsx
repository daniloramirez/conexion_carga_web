...
export const PageContainerHeader = ({
    ...
    const esTituloInicio =
        typeof title === 'string' &&
        title.trim().toLocaleLowerCase('es-CO') === 'inicio'
    const esTituloViajes =
        typeof title === 'string' &&
        title.trim().toLocaleLowerCase('es-CO') === 'administracion de viajes'
    const esTituloHistorialEliminados =
        typeof title === 'string' &&
