import { temaConexionCargaLigero } from '@/theme/coloresConexionCarga'
...
const conexionCargaTheme: ThemeVariables = {
    light: {
        primary: temaConexionCargaLigero.primary,
        primaryDeep: temaConexionCargaLigero.primaryDeep,
        primaryMild: temaConexionCargaLigero.primaryMild,
        primarySubtle: temaConexionCargaLigero.primarySubtle,
        neutral: temaConexionCargaLigero.neutral,
    },
    dark: {
        primary: '#a7e27a',
        primaryDeep: '#5a8b3e',
        primaryMild: '#c7ef9b',
        primarySubtle: '#a7e27a1f',
        neutral: '#ffffff',
    },
}
...
const presetThemeSchemaConfig: Record<string, ThemeVariables> = {
    ...
    purple: purpleTheme,
    orange: orangeTheme,
    conexionCarga: conexionCargaTheme,
}
